# Chase Sutherlin
**Mechanical Engineering (B.S.), University of Michigan-Dearborn (Class of 2028)**
[chasesut@umich.edu](mailto:chasesut@umich.edu) | +1 (616) 443-0980 | [LinkedIn URL]

I am a mechanical engineering student with a strong focus on automotive manufacturing, powertrain design, and precision machining. Combining high-level CAD simulation with hands-on fabrication, I specialize in translating complex mechanical concepts into functional, manufactured components. 
...
*(Placeholder: I will add photos of the machined gears and CAD renders here)*

### Hands-On Automotive Mechanics
*Personal Projects*
* Perform continuous DIY maintenance, diagnostics, and repairs on a 2012 Honda Accord EX Coupe and a 2001 Jeep Wrangler TJ.
* Executed complete replacements of hydraulic power steering components, door window regulators, and battery/electrical systems.
...
*(Placeholder: I will add FEA heat maps and carbon fiber layup photos here)*

---

## Technical Skills
* **CAD & Simulation:** SolidWorks, Fusion 360, CATIA, Onshape, Ansys (CFD/FEA), MATLAB
* **Automotive Quality:** APQP, PPAP, PFMEA/DFMEA, Control Plans, GD&T, Root Cause Analysis
* **Machining & Fab:** Manual Mills/Lathes, CNC Machinery, TIG/MIG Welding, Laser Cutting, Band Saws
* **Rapid Prototyping:** 3D Printing (Bambu Studio, MakerBot), Arduino IDE, Electrical Schematics
